...
function $(e,s,i=["main"],r=!0){const n=function(e,s,i){const r=Object.keys(s).concat().sort(((t,e)=>R(e)-R(t))),n=[]
...
}else if("package"===r.type){const t=e(r.path);if(t){const e=j(t,i,r.path,s);if(e)return m(e)}}else y(r.type)}(o,s,i,n)
}(n,t,e,s,r,i)}function j(t,e,s,i){for(let r=0;r<e.length;r++){const n=t[e[r]];if(n&&"string"==typeof n){
const t=a.join(a.dirname(s),n);if(i(t))return t}}}function w(t,e){return s=>{
...
;const e=t.getCompilerOptions();if(e.baseUrl&&e.paths&&Object.keys(e.paths)){const e={};e.before=[w({
